...
## 🖥️ Features
- **Overview Dashboard**
  - Latest month arrivals with YoY change
  - Year-to-date (YTD) performance with YoY change
  - Top 5 source countries of arrivals  

- **Trends Dashboard**
  - Monthly arrivals over time
  - Country ranking movement (bump chart)
  - Seasonality heatmap to highlight peak months  
...
- As of **June 2025**, YTD tourist arrivals reached **12.8 million**, recording **+8.8% growth**.  
- Clear **seasonality patterns** observed:  
...
<img width="1279" height="959" alt="Tourist Arrivals Performance" src="https://github.com/user-attachments/assets/70898a4c-b9a5-4bbd-9fb8-502d9b3059c2" />

<img width="1279" height="959" alt="Tourist Arrivals Performance (2)" src="https://github.com/user-attachments/assets/c69537ad-b30b-4c39-bc6d-13a4377c5ad8" />
